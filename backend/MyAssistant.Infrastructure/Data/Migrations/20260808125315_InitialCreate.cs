        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxRemindersPerMonth = table.Column<int>(type: "integer", nullable: false),
                    ...
                    MaxVoiceRequestsPerMonth = table.Column<int>(type: "integer", nullable: false),
                    MaxSpeechMinutesPerMonth = table.Column<int>(type: "integer", nullable: false),
                    AllowsVoice = table.Column<bool>(type: "boolean", nullable: false),
                    AllowsCalendar = table.Column<bool>(type: "boolean", nullable: false),
                    AllowsCloudBackup = table.Column<bool>(type: "boolean", nullable: false),
                    AllowsCalendarIntegrations = table.Column<bool>(type: "boolean", nullable: false),
                    AllowsAdvancedAi = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Participants = table.Column<List<string>>(type: "jsonb", nullable: false),
                    Timezone = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderPurchaseToken = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueDateTime = table.Column<string>(type: "text", nullable: true),
                    OrganizationId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WakeWordEnabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderReceipt = table.Column<string>(type: "text", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_EndDateTime",
                table: "Appointments",
                column: "EndDateTime");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsageRecords_UserId_UsageType_OccurredAt",
                table: "UsageRecords",
                columns: new[] { "UserId", "UsageType", "OccurredAt" });

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssistantResponse = table.Column<string>(type: "TEXT", nullable: false),
                    Language = table.Column<string>(type: "TEXT", nullable: false),
                    Intent = table.Column<string>(type: "TEXT", nullable: true),
                    IsVoice = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RenewalAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CancelledAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Provider = table.Column<string>(type: "TEXT", nullable: true),
                    ProviderPlanId = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoDetectLanguage = table.Column<bool>(type: "INTEGER", nullable: false),
                    AssistantVoice = table.Column<string>(type: "TEXT", nullable: true),
                    SpeechSpeed = table.Column<double>(type: "REAL", nullable: false),
                    VoiceVolume = table.Column<double>(type: "REAL", nullable: false),
                    MuteAssistantVoice = table.Column<bool>(type: "INTEGER", nullable: false),
                    WakeWordEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    WakeWord = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_UserId_StartDateTime",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ScheduledAt_IsSent",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reminders_ReminderAt",
                table: "Reminders",
                column: "ReminderAt");

            migrationBuilder.CreateIndex(
                name: "IX_Reminders_UserId_IsFired",
                table: "Reminders",
                columns: new[] { "UserId", "IsFired" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsageRecords_UserId_Type_OccurredAt",
                table: "UsageRecords",

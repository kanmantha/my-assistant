...
const DICT: Record<string, Record<UiLang, string>> = {
  ...
  todayHint: {
    en: "Try saying \"list down today's events\" — I'll read out everything scheduled for today.",
    hi: "कहें \"आज के कार्यक्रम सुनाओ\" — मैं आज के सभी निर्धारित कार्य पढ़कर सुनाऊँगा।",
    te: "\"ఈరోజు ఈవెంట్‌లు జాబితా చేయండి\" అని చెప్పండి — ఈరోజు షెడ్యూల్ చేయబడినవన్నీ నేను చదువుతాను."
  },
  ...
  pickTime: { en: "Pick a time", hi: "समय चुनें", te: "సమయం ఎంచుకోండి" },
  pickSection: { en: "Where should I save this?", hi: "इसे कहाँ सेव करूँ?", te: "దీనిని ఎక్కడ సేవ్ చేయాలి?" },
  sectionNotes: { en: "Notes", hi: "नोट्स", te: "నోట్స్" },
  sectionTasks: { en: "Tasks", hi: "कार्य", te: "టాస్క్‌లు" },
  sectionAppointments: { en: "Appointments", hi: "अपॉइंटमेंट", te: "అపాయింట్‌మెంట్లు" },
  sectionReminders: { en: "Reminders", hi: "रिमाइंडर", te: "రిమైండర్‌లు" },
